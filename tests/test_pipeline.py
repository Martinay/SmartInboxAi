...
async def test_process_file_existing_category(
    ...
    mock_settings, mock_telegram_bot, mock_metadata, tmp_path
):
    ...
    await process_file(pdf_path, mock_settings, notifier, pending_decisions)
    ...
    # 3. Notification sent
    notifier.send_auto_filed.assert_called_once_with("2024-01-01_Test.pdf", "Finance")
...
async def test_process_file_new_category(
    ...
    notifier.send_decision_request.assert_called_once()
